...
export class AddPostComponent {
      ...
      if (this.mode != undefined) {
        ...
        this.electronicApplianceService
          ...
          .subscribe((res: any) => {
            ...
            res[0].electronicApplianceImageList.forEach(
              (image: any, index: any) => {
  ...
  selectImage(event: any): void {
    ...
    this.electronicApplianceService
      .uploadElectronicApplianceImages(formData)
      .subscribe((data: any) => {
        this.progress = false;
  ...
  postAdd() {
    ...
    if (payload.id) this.updateElectronicAppliancePost(payload);
    else this.saveElectronicAppliancePost(payload);
  }
  ...
  saveElectronicAppliancePost(payload: any) {
    if (this.validatePostForm(payload)) {
      ...
      this.electronicApplianceService
        .saveElectronicAppliancePost(payload)
        .subscribe((data) => {
  ...
  updateElectronicAppliancePost(payload: any) {
    if (this.validatePostForm(payload)) {
      ...
      this.electronicApplianceService
        .updateElectronicAppliancePost(payload)
        .subscribe((data) => {
