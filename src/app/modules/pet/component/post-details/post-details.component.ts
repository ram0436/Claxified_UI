...
export class PostDetailsComponent {
  ...
  constructor(private petService: PetService, private route: ActivatedRoute, private router: Router, private dialog: MatDialog,
  ...
  getSportPost(guid: any) {
    this.petService.getPetPostByGuid(guid).subscribe((data: any) => {
      ...
      this.imagesList = this.postDetails.petImageList;
    });
  }
