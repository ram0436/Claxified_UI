...
export class PostDetailsComponent {
  ...
  constructor(private commercialService: CommercialService, private route: ActivatedRoute, private router: Router, private dialog: MatDialog,
    private commonService : CommonService,private location : Location, private UserService: UserService, private snackBar: MatSnackBar,  private AdminDashboardService: AdminDashboardService) { 
  ...
  getSportPost(guid: any) {
    this.commercialService.getCommercialServicePostByGuid(guid).subscribe((data: any) => {
      this.postDetails = data[0];
      this.isLoading = false;
      this.imagesList = this.postDetails.commercialServiceImagesList;
    });
  }
