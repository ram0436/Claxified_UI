...
@Component({
  selector: 'app-sport-posts',
  templateUrl: './sport-posts.component.html',
  styleUrls: ['./sport-posts.component.css', '../../../moduleposts.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class SportPostsComponent {
